...
import InteractiveBanners01 from "../Components/DigitalAgency/InteractiveBanners/InteractiveBanners01";
...
import PortfolioColorful from "../Components/Global/Portfolio/PortfolioColorful";
import FooterStyle12 from "../Components/DigitalAgency/Footer/FooterStyle12";
import TestimonialsCarousel07 from "../Components/DigitalAgency/TestimonialCarousel/TestimonialsCarousel07";
import Clients from "../Components/Global/Clients/Clients";
import BlogOverlayImg from "../Components/DigitalAgency/Blogs/BlogOverlayImg";
import SideButtons from "../Components/Global/SideButtons";

// Data
import { InteractiveBannersData01 } from "../Components/Global/InteractiveBanners/InteractiveBannersData";
...
const blogOverlayImgData = blogData.filter(
  (item) => item.blogType === "overlayImage"
);
    ...
    <div style={props.style}>
      ...
      <div className="bg-white">
              ...
              >
                <Navbar.Brand className="inline-block p-0 m-0">
                  ...
                  <img
                    ...
                    height="36"
                    loading="lazy"
                    src="/assets/img/webp/logo-brownish-orange-green.webp"
                    data-rjs="/assets/img/webp/logo-brownish-orange-green@2x.webp"
                    alt="logo"
                  />
                  <img
          ...
          <Container className="relative md:h-full">
            <Row className="h-[100vh] md:h-full">
              <Col className="flex flex-col">
                <h1 className="font-serif font-semibold text-white text-[130px] leading-[120px] w-[50%] mt-auto mb-0 tracking-[-5px] lg:text-[110px] lg:leading-[100px] md:text-[90px] md:leading-[85px] sm:text-[50px] sm:leading-[50px] sm:-tracking-[.5px] xs:w-[70%] xs:text-[60px] xs:leading-[65px]">
                  Digital agency
                </h1>
                <div className="flex flex-row items-center mt-auto mb-[7.5rem]">
                  ...
                  <span className="font-serif text-lg text-[#e6994e] xs:text-xmd">
          ...
          <Container>
            <Row className="items-center justify-center">
              <Col xl={5} md={6} xs={11} className="sm:mb-[30px]">
                ...
                >
                  We are creative digital agency working for huge brands
                </m.h2>
              </Col>
        ...
        <InViewPort>
              ...
              <div className="row items-center">
                ...
                >
                  ...
                  <p className="text-lg leading-[38px] xs:w-[90%] md:text-xmd">
                    Lorem ipsum consectetur adipiscing elit do eiusmod tempor
                    incididunt.
                  </p>
                </m.div>
                <m.div
                ...
                <m.div
                  className="col-md-4 offset-xl-1"
            ...
            <Container fluid>
              <Row>
                ...
                <Col
                  ...
                  style={{
                    backgroundImage: `url('https://via.placeholder.com/1139x782')`,
                  }}
                ></Col>
                <Col
                  xl={5}
                  lg={6}
                  className="bg-darkgray py-40 px-[9%] xl:p-[6%] lg:p-[6%] md:p-[10%] sm:py-[15%] sm:px-[10%]"
                >
                  <m.span
                    {...fadeIn}
                    className="font-serif font-medium text-[#e6994e] tracking-[2px] uppercase block mb-[35px]"
                  >
                    Let's work together
                  </m.span>
                  <m.h2
                    {...{ ...fadeIn, transition: { delay: 0.4 } }}
                    className="heading-4 font-serif font-semibold text-white -tracking-[.5px] mb-12 w-[90%] sm:w-full"
                  >
                    Digital technology and marketing for leading brands
                  </m.h2>
                  <m.p
                    {...{ ...fadeIn, transition: { delay: 0.6 } }}
                    className="text-lg leading-[38px] mb-[42px] w-[90%] lg:w-full md:w-[80%] sm:w-full md:text-xmd"
                  >
                    Lorem ipsum dolor amet consectetur nostrud eiusmod tempor
                    incididunt et dolore enim minim veniam nostrud exercitation
                    laboris nisi ut aliquip ex ea commodo incididunt.
                  </m.p>
                  <m.div {...{ ...fadeIn, transition: { delay: 0.8 } }}>
                    <Buttons
                      ariaLabel="link for conatct modern page"
                      to="/page/contact-modern"
                      className="font-medium font-serif uppercase btn-link after:h-[2px] md:text-md md:mb-[15px] after:bg-white hover:text-white tracking-[1px]"
                      size="xl"
                      color="#fff"
          ...
          {/* Section Start */}
          <m.section
            className="pt-[100px] pb-0 py-[130px] overflow-hidden xs:py-[50px]"
            {...fadeIn}
          >
            <Container>
              <Row sm={2} xs={1} className="items-center">
                <Col className="xs:text-center xs:mb-[10px]">
                  <h2 className="heading-4 font-serif font-semibold text-darkgray mb-0">
                    Selected work
                  </h2>
                </Col>
                <Col className="text-right xs:text-center">
                  <Buttons
                    ariaLabel="link for portfolio"
                    to="/portfolio/portfolio-colorful-four-column"
                    className="font-medium font-serif uppercase btn-link after:h-[2px] !text-md md:mb-[15px] after:bg-black hover:text-darkgray xs:mb-[2px]"
                    color="#000"
          ...
          {/* Section Start */}
          <m.section
            className="py-[130px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]"
            {...fadeIn}
          >
            <Container>
              <Counter
          ...
          {/* Section Start */}
          <section
            className="digital-agency-testimonial-carousel pt-[160px] pb-[130px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]"
            style={{
              backgroundImage: `url(${"https://via.placeholder.com/1920x983"})`,
            }}
          >
            <Container>
              <m.div
                className="row justify-center text-center items-center"
                {...fadeIn}
              >
              ...
              <Clients
                grid="row row-cols-1 row-cols-lg-4 row-cols-sm-2 mt-[8.5rem] client-logo-style-07 lg:mt-20 xs:mt-[30px]"
            ...
            <Container>
              <Row sm={2} xs={1} className="items-center">
                <Col className="text-left xs:mb-[10px]">
                  <h2 className="heading-4 xs:text-center font-serif font-semibold text-darkgray mb-0">
                    Latest stories
                  </h2>
                </Col>
                <div className="text-right xs:text-center">
                  <Buttons
                    ariaLabel="link for blog overlay"
                    to="/blogs/blog-overlay-image"
                    className="font-medium font-serif uppercase btn-link after:h-[2px] !text-md md:mb-[15px] after:bg-black hover:text-darkgray"
                    color="#000"
                    title="All stories"
                  />
                </div>
              ...
              <Row>
                <Col className="mt-20 px-0">
                  <BlogOverlayImg
                    ...
                    data={blogOverlayImgData.slice(0, 3)}
                  />
                </Col>
              </Row>
            </Container>
      ...
      {/* Footer Start */}
      <FooterStyle12
        className="footer-digitalagency text-[#828282] bg-white"
        theme="light"
        logo="/assets/img/webp/logo-light-brownish-orange-black.webp"
      />
      {/* Footer End */}
    </div>
  );
