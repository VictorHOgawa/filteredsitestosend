...
import Buttons from "../Components/Global/Button/Buttons";
import ProgressBar from "../Components/MarketingAgency/ProgressBar/ProgressBar";
import Counter from "../Components/Global/Counters/Counter";
import ProcessStep from "../Components/MarketingAgency/ProcessStep/ProcessStep";
import TextSlider02 from "../Components/MarketingAgency/TextSlider/TextSlider02";
import Clients from "../Components/Global/Clients/Clients";
import Testimonials from "../Components/MarketingAgency/Testimonials/Testimonials";
import BlogGrid from "../Components/MarketingAgency/Blogs/BlogGrid";
import SocialIcons from "../Components/Global/SocialIcon/SocialIcons";
...
import { Input } from "../Components/Global/Form/Form";
import SideButtons from "../Components/Global/SideButtons";
import ReactCustomScrollbar from "../Components/Global/ReactCustomScrollbar";
import StaticInstagram from "../Components/Global/Instagram/StaticInstagram";

// Data
import { blogData } from "../Components/Global/Blogs/BlogData";
import { TestimonialsData03 } from "../Components/MarketingAgency/Testimonials/TestimonialsData";
import { CounterData04 } from "../Components/Global/Counters/CounterData";
import { ProcessStepData06 } from "../Components/MarketingAgency/ProcessStep/ProcessStepData";
    ...
    <div style={props.style}>
      ...
      <Header topSpace={{ md: true }} type="reverse-scroll">
        <HeaderNav
          ...
          theme="dark"
          expand="lg"
          className="px-[35px] py-[0px]  md:pl-0 md:pr-[15px] md:py-[20px] sm:pr-0"
        >
            ...
            <HamburgerMenu className="" theme="dark">
              <Col className="flex flex-col justify-center px-[50px] py-[70px] w-[500px] h-[100vh] shadow-[0_0_20px_rgba(0,0,0,0.3)] right-0 text-center bg-white">
                <ReactCustomScrollbar theme="dark">
                  <div>
                    <h1 className="mb-0 font-bold tracking-[-3px] text-darkgray tracking-[-3px] font-serif uppercase">
                      Hello
                    </h1>
                    <p className="text-lg font-serif uppercase block">
                      Let's be friends.
                    </p>
                          ...
                          <div className="relative subscribe-style-05">
                            <Form className="relative">
                              ...
                              <button
                                ...
                                type="submit"
                                className={`text-xs leading-[18px] py-[12px] px-[28px] tracking-normal uppercase xs:text-center${
                                  isSubmitting ? " loading" : ""
                                }`}
                              >
                                <i className="far fa-envelope text-darkgray text-sm leading-none mr-[10px] xs:mr-0"></i>
                                Subscribe
                              </button>
                            </Form>
                            <AnimatePresence>
          ...
          {SwiperData.map((item, i) => {
            return (
              <SwiperSlide
                ...
                className="cover-background overflow-hidden relative"
              >
                ...
                <Container className="h-full  text-center justify-center">
                  <Row className="h-full w-[70%] md:w-full my-0 mx-auto">
                    <Col className="h-full justify-center flex-col relative flex">
                      <h2 className="font-serif font-light text-white mb-16">
                        {item.title}
                        <span className="font-semibold">{item.titlebold}</span>
                        {item.titlelast}
                      </h2>
                      <div className="inline-block xs:grid xs:justify-center">
                        <Buttons
                          to="/page/our-services"
                          className="mr-[20px] btn-fancy tracking-[1px] btn-fill rounded-none font-medium font-serif uppercase btn-fancy md:mb-[15px] sm:mb-0 xs:block xs:w-full xs:mx-0"
                          size="md"
                          color="#000"
                          themeColor="#f4d956"
                        ...
                        <Buttons
                          to="/"
                          className="btn-fancy tracking-[1px] rounded-none font-medium font-serif uppercase btn-transparent hover:text-black xs:block xs:w-fit xs:mx-0"
                          themeColor="#fff"
                          size="md"
                          color="#fff"
      ...
      <section className="py-[100px] text-left overflow-hidden md:py-[85px] sm:py-[60px]">
        <Container>
          <Row className="items-center">
            ...
            <Col lg={9}>
              <ProcessStep
                className="xs:block items-center mx-auto justify-center text-center sm:text-start"
                grid="col-xl-10 gap-y-10"
                theme="process-step-style-06"
                data={ProcessStepData06}
      ...
      <InViewPort>
          ...
          <Container>
            <Row className="items-center justify-center">
              <div className="relative bottom-[-50px] z-[1] col-lg-6 col-md-10">
                <Parallax
                  className="lg-no-parallax flex justify-center h-full items-center w-full bg-no-repeat absolute bottom-0 right-[-20px] xs:right-0 lg:!top-[30px]"
                  speed={20}
                >
                  <m.div
                    className="marketing-agency-parallx"
                    {...{ ...fadeInRight, transition: { duration: 0.8 } }}
                  >
                    <span className="text-overlap-style-04 font-serif font-semibold -tracking-[3px] xs:text-[55px]">
                      marketing
                    </span>
                  </m.div>
                </Parallax>
                <Parallax speed={0}>
                  <m.img
                    ...
                    width={444}
                    height={642}
                    src="https://via.placeholder.com/800x1158"
                    alt=""
                    {...{
                      ...fadeInRight,
              ...
              <m.div
                className="mb-[80px] xs:mb-20 md:mt-[100px] col-xl-4 col-lg-5 col-md-10 offset-xl-1"
                {...fadeIn}
              >
                <h2 className="heading-5 font-medium font-serif text-white">
                  We provide true{" "}
                ...
                <p className="text-[#fff] text-xmd leading-[32px] w-[95%] mb-[25px] opacity-60">
                  Lorem ipsum dolor amet consectetur adipiscing eiusmod tempor
                  incididunt labore dolore magna ut enim veniam nostrud
                  exercitation.
                </p>
                <Link
                  to="/page/about-us"
                  className="mt-[15px] text-[#fff] text-xmd font-serif hover:text-[#fff]"
                >
                  More about us
        ...
        <m.section className="overflow-visible block p-0 relative" {...fadeIn}>
          <div className="right-0 bottom-[-50px] font-semibold tracking-[-10px] leading-[200px] text-[#fff] text-[200px] font-serif absolute lg:text-[160px] lg:leading-[160px] md:hidden">
            business
          </div>
        </m.section>
        {/* Section End */}
        ...
        >
          <Container>
            ...
            <Counter
              theme="counter-style-04 marketing-agency-counter"
              grid="row-cols-1 row-cols-md-4 row-cols-sm-2 gap-y-10 mt-[118px] sm:mt-[60px]"
        ...
        <section className="py-[160px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px] ">
          <Container>
            <Clients
              className="col-10 col-md-3 col-sm-6"
              grid="row-cols-1 row-cols-sm-2 row-cols-md-4 justify-center"
              theme="client-logo-style-06 light"
              data={ClientData}
              animation={fadeIn}
            />
          </Container>
        ...
        {/* Section Start */}
        <section
          className="bg-no-repeat bg-cover	overflow-hidden relative bg-center md:pt-[75px] xs:pt-[50px]"
          style={{
            backgroundImage:
              "url(/assets/img/webp/home-marketing-agency-bg-img-05.webp)",
          }}
        >
          <Container>
            <Row className="items-center justify-center">
              ...
              >
                <m.div
                  {...{ ...fadeIn, transition: { delay: 0.5, duration: 0.6 } }}
                >
                  <img
                    src="/assets/img/webp/home-marketing-agency-img-02.webp"
                    alt=""
                    className="mb-[20px] md:mt-0 md:mx-auto"
                  />
                  <div>
                    <h4 className="font-serif font-light text-darkgray tracking-[-1px] w-[65%] mb-12 md:w-full">
                      President's
                      <span className="font-semibold"> message</span>
                    </h4>
                    <span className="mb-[20px] text-lg leading-[30px] text-[#fff] w-[86%] block xs:w-full xs:text-xmd xs:leading-[22px] md:text-center md:mx-auto">
                      Diamonds are nothing more than chunks of coal that stuck
                      to their jobs.
                    </span>
                    <p className="text-[#fff] opacity-60	w-[85%] md:w-full mb-[50px] xs:mb-[15px]">
                      Lorem ipsum dolor sit amet consectetur adipiscing elit
                      eiusmod tempor incididunt labore et dolore magna minim
                      veniam nostrud exercitation ullamco.
                    </p>
                    <img
                      src="/assets/img/webp/home-restaurant-img-transparent-06.webp"
                      alt=""
                      className="md:my-0 md:mx-auto"
                    />
                  </div>
                </m.div>
              </Col>
              <Col xs={10} lg={{ span: 7, order: 1 }}>
                <div className="relative">
                  <m.img
                    ...
                    width="597px"
                    height="781px"
                    src="https://via.placeholder.com/597x781"
                    alt=""
                    {...{ ...fadeIn, transition: { duration: 1 } }}
                  />
                  <m.div
                    className="marketingagency-quote absolute left-[10px] bottom-[160px] rounded-[4px] py-[40px] px-[45px] bg-[#f4d956] text-left w-[50%] before: xs:p-[15px] sm:text-lg xs:w-[70%] xs:bottom-[50px]"
                    {...{
                      ...fadeIn,
                  ...
                  >
                    <span className="leading-[32px] -tracking-[.5px] text-darkgray text-xlg font-serif block sm:text-lg">
        ...
        {/* Section Start */}
        <m.section
          className="bg-gradient-to-b from-[#fff] to-[#f0f2f0] pt-[130px] overflow-hidden lg:pt-[90px] md:pt-[75px] sm:pt-[50px]"
          {...fadeIn}
        >
          <Container>
            <Row className="justify-center text-center">
              <Col lg={4} className="mb-16 text-center">
                <span className="mb-[5px] text-[#969896] font-serif uppercase block tracking-[1px]">
                  Testimonials
                </span>
                <h2 className="heading-5 font-semibold text-darkgray font-serif">
                  Customer reviews
                </h2>
              </Col>
            </Row>
            <Row className="justify-center">
              <Col md={12} sm={8}>
                <Testimonials
                  className="marketing-agency-testimonials"
          ...
          <Container>
            <Row className="justify-center text-center">
              <Col className="mb-[56px]">
                <span className="mb-[5px] text-[#969896] tracking-[1px] font-serif uppercase block">
                  Latest blog
                </span>
                <h2 className="heading-5 font-semibold text-darkgray font-serif">
                  Popular articles
            ...
            <Row>
              <Col>
                <BlogGrid
                  grid="blog-wrapper grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large"
                  data={blogGridData.slice(1, 4)}
                />
              </Col>
            </Row>
          </Container>
              ...
              >
                ...
                <h3 className="heading-4 text-[#f4d956] font-semibold font-serif mb-0 mt-[5px]">
                  <a
                    ...
                    className="text-decoration-line-bottom-thick hover:opacity-50 hover:text-[#828282]"
                  >
                    info@domain.com
                  </a>
                </h3>
        ...
        {/* Footer Start */}
        <Footer
          className="py-[50px] border-t border-mediumgray items-center"
          theme="light"
        >
          <Container>
              ...
              >
                <p className="mb-0 uppercase text-sm  sm:text-center">
                  ...
                  <a
                    ...
                    className="text-black underline underline-offset-4 font-medium hover:opacity-50"
                    target="_blank"
                  >
                    {" "}
                    ThemeZaa
