...
import ProductBox from "../Components/FurnitureShop/Products/ProductBox";
import { fadeIn } from "../Functions/GlobalAnimations";
import BlogClassic from "../Components/FurnitureShop/Blogs/BlogClassic";
import Instagram from "../Components/Global/Instagram/Instagram";
import Overlap from "../Components/Global/Overlap/Overlap";
import MessageBox from "../Components/Global/MessageBox/MessageBox";
import FooterMenu, { Footer } from "../Components/Global/Footer/Footer";
                    ...
                    >
                      ...
                      >
                        <Buttons
                          ariaLabel="shop wide"
                          to="/shop/shop-wide/"
                          className="font-medium text-[8px] mx-3 uppercase rounded-none shadow-[0_0_15px_rgba(0,0,0,0.1)] bg-[#fff] hover:bg-white hover:text-black border-none"
                          color="#000"
                          size="lg"
                          themeColor="#000"
                          title="Discover Now"
          ...
          <Container>
            <Row className="pb-[40px]">
              ...
              <Col className="col-12 col-lg-4 col-md-6 flex items-center text-center md:text-end">
                <img
                  src="/assets/img/webp/footer-payment-icon.webp"
