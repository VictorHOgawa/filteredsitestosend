...
// Components
import Header, { CollapsibleMenu } from "../Components/Global/Header/Header";
import ReactCustomScrollbar from "../Components/Global/ReactCustomScrollbar";
import MouseMove from "../Components/Photography/MouseMove";
import { fadeIn, fadeInLeft, zoomIn } from "../Functions/GlobalAnimations";
import Buttons from "../Components/Global/Button/Buttons";
import Overlap from "../Components/Global/Overlap/Overlap";
import Clients from "../Components/Global/Clients/Clients";
import InteractiveBanners06 from "../Components/Photography/InteractiveBanners/InteractiveBanners06";
import PortfolioJustifiedGallery from "../Components/Photography/Portfolio/PortfolioJustifiedGallery";
import TestimonialsCarousel09 from "../Components/Photography/TestimonialCarousel/TestimonialsCarousel09";
import BlogMetro from "../Components/Global/Blogs/BlogMetro";
...
const blogMetroData = blogData
  ...
  .filter((item) => item.category.includes("photography"));
...
const PhotographyPage = (props) => {
  ...
  return (
    <div style={props.style}>
      ...
      <Header
        topSpace={{ md: true }}
        className="left-menu-modern-sidebar fixed top-0 left-0 z-10 md:w-full md:h-auto"
      >
        <div className="bg-black sidebar-nav-action h-[100vh] md:h-auto w-[65px] md:w-full py-[30px] flex flex-col md:flex-row md:justify-between md:px-[30px] md:py-[15px] sm:px-[15px]">
          <Col className="flex justify-center md:justify-start">
            <Link aria-label="header logo" to="/">
              <img
                ...
                alt=""
                src="/assets/img/webp/symbol.webp"
              />
            </Link>
          </Col>
          <Col className="flex items-center justify-center xs:justify-end">
            <Navbar className="inline-block" variant="dark">
              ...
              <div
                className={`left-menu-wrapper flex items-center w-[380px] bg-[#000] hover:bg-darkgray md:hover:bg-[#000] transition-default fixed top-[var(--header-height)] left-[65px] md:left-0 xs:w-full -z-10 h-[calc(100vh-var(--header-height))]${
                  show ? " show" : ""
                }`}
              >
                <div className="col-12 h-full px-[3.5rem] sm:px-4">
                  ...
                  >
                    <div>
                      <CollapsibleMenu
                        className="w-full mx-auto xs:px-[15px]"
                        theme="light"
                      />
                    </div>
                  </ReactCustomScrollbar>
      ...
      <div className="pl-[65px] md:pl-0">
        ...
        <section className="relative">
          ...
          >
            ...
            >
              ...
              <span>
                {addZeroBeforeNumber(
                  activeSlide === 0 ? SwiperImgData.length : activeSlide
                )}
              </span>
            </div>
                ...
                >
                  ...
                  <Row className="h-full">
                    <Col className="h-full justify-center items-center flex flex-col">
                      ...
                      >
                        <div className="relative z-[5] flex justify-center lg:inline-block text-gradient bg-gradient-to-r from-[#0cd6a2] via-[#56de9c] to-[#c7da26]">
                          {item.title}
                        </div>
                        <MouseMove
                          enableOnHover={true}
                        ...
                        >
                          <span className="inline-block text-border text-border-width-2px text-[#728a70]">
                            {item.title}
                          </span>
                        </MouseMove>
                      </m.div>
                      <m.span
                        className="inline-block uppercase tracking-[19px] text-[24px] lg:text-lg md:text-md sm:text-sm xs:text-xs xs:tracking-[10px] leading-[26px] text-white mt-[25px] landscape:md:text-[7px] landscape:md:leading-[8px] landscape:md:tracking-[7px] landscape:md:mt-0"
                        initial={{ opacity: 0 }}
                        animate={
            ...
            >
              <span>
                {addZeroBeforeNumber(
                  activeSlide === SwiperImgData.length - 1
                    ? "1"
                    : activeSlide + 2
                )}
              </span>
        ...
        <section
          className="py-[160px] cover-background overflow-hidden lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]"
          style={{
            backgroundImage: `url('https://via.placeholder.com/1856x877')`,
          }}
        >
          <Container fluid>
            <m.div className="row justify-end items-end mb-[200px] sm:mb-0">
              <Col xl={3} lg={5} md={6} className="sm:mb-[30px]">
                <h2 className="font-serif font-semibold text-basecolor mb-12 md:w-[95%]">
                  about photographer
                </h2>
                <span className="text-lg leading-[36px] inline-block w-[75%] lg:w-[90%] opacity-60 md:text-xmd xs:leading-[22px]">
                  Hello, I am a highly organised motivated professional
          ...
          <Container>
              ...
              <Overlap>
                <Col className="relative text-center">
                  <m.img
                    width={385}
                    height={705}
                    src="https://via.placeholder.com/385x705"
                    className="mx-auto mt-[5.5rem] xs:mt-32"
                    alt="photography"
            ...
            <Row className="justify-center">
              <Col lg={3} className="text-center relative -top-[50px] mb-20">
                ...
                <m.span
                  className="font-serif text-lg uppercase tracking-[3px] block font-medium"
                  {...fadeIn}
                >
                  Expertise area
                </m.span>
        ...
        <section className="py-[160px] bg-[#131313] overflow-hidden lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]">
          <Container>
            <Row>
              <m.div
                className="md:mb-[50px] xs:mb-[35px] col-xl-5 col-lg-6 col-md-7"
                {...fadeIn}
              >
                <h2 className="heading-3 font-serif font-semibold text-white mb-[30px] xs:mb-8">
                  I am always ready for a challenge.
                </h2>
                <Buttons
                  ariaLabel="link for"
                  to="/portfolio/portfolio-justified-gallery"
                  className="font-medium border-0 flex items-center font-serif uppercase md:mb-[15px] hover:text-white p-0 xs:mb-0"
                  size="xl"
                  color="#c7da26"
                  title="Explore portfolio"
                  icon="line-icon-Arrow-OutRight ml-[15px] text-[40px]"
                  iconPosition="after"
                />
              </m.div>
              <m.div
                className="xs:mb-[35px] col-lg-3 col-sm-6 offset-xl-1"
                {...{
                  ...fadeInLeft,
                  transition: { delay: 0.4, duration: 1, ease: "circOut" },
                }}
              >
                <span className="text-lg inline-block mb-[15px] font-serif text-white xs:text-xmd xs:leading-[22px]">
                  15+ Award winner
                </span>
                <p className="text-lg leading-[36px] inline-block w-[90%] opacity-60 xs:text-xmd xs:leading-[22px]">
            ...
            <Row className="justify-center">
              <Col xl={11} className="mt-[10.5rem] xs:mt-12">
                <PortfolioJustifiedGallery
                  filter={false}
                  grid="grid grid-3col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large"
        ...
        {/* Section start */}
        <m.div
          className="relative overflow-hidden pb-[130px] lg:pb-[90px] md:pb-[100px] sm:pb-[50px] sm:px-[15px]"
          {...fadeIn}
        >
          <Parallax
            className="lg-no-parallax bg-cover cover-background absolute top-[-30px] left-0 h-[100vh] w-full"
            translateY={[-40, 40]}
            style={{
            ...
            <Container>
              <Row className="justify-center">
                <Col lg={3} className="text-center mb-20">
                  ...
                  <span className="font-serif text-lg uppercase tracking-[3px] relative block font-medium xs:text-xmd xs:leading-[22px]">
                    Testimonials
                  </span>
                </Col>
              </Row>
        ...
        <section className="pb-[130px] bg-[#131313] overflow-visible lg:pb-[90px] md:pb-[75px] sm:py-[50px]">
          <Container>
            <Row>
              <Overlap className="mb-[90px] sm:mb-[50px] xs:mb-12">
                <Col className="text-center relative">
                  <span className="font-serif font-semibold inline-block text-[11rem] leading-[11rem] text-gradient photography-bg-gradient -tracking-[7px] lg:-tracking-[1.5px] sm:text-[8rem] xs:text-[5rem]">
                    memories
                  </span>
                </Col>
              </Overlap>
            ...
            <Clients
              grid="row-cols-1 row-cols-md-2 row-cols-lg-4 justify-center"
        ...
        <section className="py-[160px] border-t border-[#ffffff1a] bg-[#131313] overflow-hidden lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]">
          <Container>
            <Row className="items-center">
              <Col
                lg={6}
                sm={8}
                className="text-left xs:mb-[15px] xs:text-center"
              >
                <h2 className="heading-4 font-serif font-semibold text-white mb-0">
                  Latest blog posts
                </h2>
              </Col>
              <Col lg={6} sm={4} className="text-right xs:text-center">
                <Buttons
                  ariaLabel="link for"
                  to="/blogs/blog-metro"
                  className="font-medium font-serif uppercase btn-link after:h-[2px] md:text-md md:mb-[15px] after:bg-[#c7da26] hover:text-basecolor hover:bg-basecolor"
                  size="xl"
                  color="#c7da26"
                  title="View all post"
                />
          ...
          <Container className="p-0">
            <BlogMetro
              pagination={false}
              grid="mt-[7.5rem] grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-large xs:mt-[5.5rem]"
              data={blogMetroData}
            />
          </Container>
        </section>
            ...
            <Container>
              <Row>
                <Col md={3} className="sm:mb-[20px]">
                  ...
                  >
                    <img
                      className="max-h-[36px] align-middle"
                      alt="logo"
