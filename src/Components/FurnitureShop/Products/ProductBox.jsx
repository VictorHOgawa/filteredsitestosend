                ...
                >
                  <div className="product-image relative overflow-hidden">
                    <Link aria-label="link" to="/shop/single-product/">
                      {item.img && (
                        <img
                          width={297}
                          height={379}
                          className="default-image w-full"
                          src={item.img}
                          alt="product-box"
                        />
                      )}
                        ...
                        return (
                          item.title && (
                            <span
                              ...
                              className="absolute top-[25px] left-[25px] text-[10px] text-semibold text-[#fff] leading-[11px] font-sans text-center uppercase block py-[5px] px-2 rounded-sm"
                            >
                              {item.title}
                            </span>
                          )
                    ...
                    <div className="product-hover-details">
                      <Link
                        ...
                        to="#"
                        className="font-serif text-[#fff] text-sm font-medium uppercase"
                      >
                        <i className="feather-shopping-bag mr-[10px]"></i>Add to
                        cart
                      </Link>
                    </div>
                    <div className="product-hover-right absolute top-0 right-0 transition-default py-[20px] pr-[15px] w-[65px] transition-default">
                      <OverlayTrigger
                        overlay={(props) => (
                          <Tooltip {...props}>QUICK SHOP</Tooltip>
                        )}
                        placement="left"
                      >
                        <Link
                          aria-label="productbox"
                          to="#"
                          className="product-link-icon move-top-bottom relative rounded-full bg-[#fff] text-darkgray inline-block text-center transition-default m-[5px] h-[40px] w-[40px] leading-[45px]"
                        >
                  ...
                  <div className="product-footer text-center pt-[25px] xs:pt-[10px]">
                    <Link
                      ...
                      className="text-darkgray hover:text-black font-medium inline-block"
                    >
                      {item.title}
                    </Link>
                    {(item.price || item.oldPrice) && (
                      <div className="product-price text-md">
                        {item.oldPrice && (
