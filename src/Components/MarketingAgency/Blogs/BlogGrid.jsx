...
// Data
import { authorData, blogData } from "../../Global/Blogs/BlogData";
              ...
              >
                ...
                <div className="px-12 py-10 bg-white sm:px-8 xs:px-12">
                  ...
                  <div className="flex items-center">
                    {authorData.filter(
                      ...
                      <>
                        <img
                          width={30}
                          height={30}
                          className="w-[30px] rounded-full mr-[10px]"
                          src={
                            authorData.filter(
                              (author) => author.id === item.author
                            )[0].img
                    ...
                    {(item.link || item.likes) && (
                      <Link
                        aria-label="link"
                        to="#"
                        className="items-center flex justify-center text-xs font-serif hover:text-basecolor"
                      >
