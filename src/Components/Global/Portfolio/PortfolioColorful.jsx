          ...
          {props.data.map((item, i) => {
            return (
              <SwiperSlide key={i}>
                ...
                >
                  <Link
                    aria-label="link for filter content"
                    target={props.target}
                    to={item.link}
                  >
                    <div
                      ...
                      <div className="portfolio-image">
                        {item.img && (
                          <img
                            ...
                            height={675}
                            width={540}
                            alt="portfolio-colorful"
                          />
                        )}
                        <div className="portfolio-hover justify-between flex">
                          <div className="portfolio-content">
                            {item.subtitle && (
                              <span className="text-sm font-serif text-white uppercase mb-[5px] opacity-70 inline-block">
                                {item.subtitle}
                              </span>
                            )}
                            {item.title && (
                              <h3 className="heading-6 font-semibold text-white uppercase mb-0">
                                {item.title}
                              </h3>
                            )}
                          </div>
